...
exports.postAddCar = (req, res, next) => {
  ...
  const product = new Product(null, title, imageUrl, description, price);  //t, iUrl, desc, pr (same order as in the constructor)
  product.save();
